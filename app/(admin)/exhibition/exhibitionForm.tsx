...
export default function ExhibitionForm<T extends BaseFormData>({ initialData, form }: FormProps<T>){
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        data.append("descriptionHTML", JSON.stringify(contentHTML));
        data.append("descriptionText", JSON.stringify(contentText));
                ...
                <GridScroll container spacing={3}>
                    ...
                    <Grid size={12}>
                        <StyledRichTextEditor>
                            <TiptapEditor ref={rteRef} content={values.descriptionHTML} />
                            {/* <RichTextEditor
                                ref={rteRef}
                                extensions={[
